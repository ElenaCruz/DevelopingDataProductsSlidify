...
Parent 1 height (in cms) = `r Parent1Input <- 175; Parent1Input`

Parent 2 height (in cms) = `r Parent2Input <- 170; Parent2Input`

Predicted children height = `r childrenHeight <- function(Parent1Input,Parent2Input) mean(c(Parent1Input, Parent2Input));childrenHeight(Parent1Input, Parent2Input)`cms.
